<template>
  ...
  <div
    class="container center-align selection"
    style="background-color: #d1c4e9; width: 100vw"
  >
    <div class="row option" style="">
      <div class="col s12 center align">
        <p style="font-size: 5vw; margin: 0px; color: #350b49">
          Session Wizard
        </p>
        ...
        <div class="input-field">
          <router-link to="/login"
            ><a
              class="btn waves-effect waves-purple my-color-back"
  ...
  <div
    class="card-panel my-color-card class-engagement-wrapper"
