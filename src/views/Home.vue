...
<div class="container">
  <div class="row">
    ...
    <p class="center-align" style="font-size:2vw">Please Select an Option Below to Access the application</p>
  </div>
</div>
  ...
  <div class="container center-align selection" style="background-color:#d1c4e9;width:65vw;">
   ...
   <p style="font-size:3vw;margin:0px;color:#350b49">Lecturers</p>
